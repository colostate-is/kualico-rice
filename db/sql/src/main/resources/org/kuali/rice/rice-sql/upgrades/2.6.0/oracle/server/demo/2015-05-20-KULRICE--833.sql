...
INSERT INTO KREW_RULE_TMPL_T(RULE_TMPL_ID, NM, RULE_TMPL_DESC, DLGN_RULE_TMPL_ID, VER_NBR, OBJ_ID)
  VALUES('1645', 'BloomingtonBranchApprovalRuleTemplate', 'BloomingtonBranchApprovalRuleTemplate', NULL, 1, SYS_GUID())
/
INSERT INTO KREW_RULE_TMPL_T(RULE_TMPL_ID, NM, RULE_TMPL_DESC, DLGN_RULE_TMPL_ID, VER_NBR, OBJ_ID)
  VALUES('1646', 'IndianapolisBranchApprovalRuleTemplate', 'IndianapolisBranchApprovalRuleTemplate', NULL, 1, SYS_GUID())
/
INSERT INTO KREW_RULE_TMPL_T(RULE_TMPL_ID, NM, RULE_TMPL_DESC, DLGN_RULE_TMPL_ID, VER_NBR, OBJ_ID)
  VALUES('1647', 'OtherCampusBranchApprovalRuleTemplate', 'OtherCampusBranchApprovalRuleTemplate', NULL, 1, SYS_GUID())
/
...
INSERT INTO KREW_DOC_TYP_T(DOC_TYP_ID, PARNT_ID, DOC_TYP_NM, DOC_TYP_VER_NBR, ACTV_IND, CUR_IND, LBL, PREV_DOC_TYP_VER_NBR, DOC_TYP_DESC, DOC_HDLR_URL, POST_PRCSR, JNDI_URL, BLNKT_APPR_PLCY, ADV_DOC_SRCH_URL, RTE_VER_NBR, NOTIFY_ADDR, APPL_ID, EMAIL_XSL, SEC_XML, VER_NBR, BLNKT_APPR_GRP_ID, RPT_GRP_ID, GRP_ID, HELP_DEF_URL, OBJ_ID, DOC_SEARCH_HELP_URL, DOC_HDR_ID, AUTHORIZER)
  VALUES('3046', NULL, 'XPathSplitNodeExampleDocType', 0, 1, 1, 'XPath SplitNode Example DocType', NULL, 'XPath SplitNode Example DocType', '${workflow.url}/EDocLite', 'org.kuali.rice.edl.framework.workflow.EDocLitePostProcessor', NULL, NULL, NULL, '2', NULL, NULL, NULL, NULL, 1, '1', NULL, '1', NULL, SYS_GUID(), NULL, NULL, NULL)
/
...
INSERT INTO KREW_RULE_T(RULE_ID, NM, RULE_TMPL_ID, RULE_EXPR_ID, ACTV_IND, RULE_BASE_VAL_DESC, FRC_ACTN, DOC_TYP_NM, DOC_HDR_ID, TMPL_RULE_IND, FRM_DT, TO_DT, DACTVN_DT, CUR_IND, RULE_VER_NBR, DLGN_IND, PREV_VER_RULE_ID, ACTVN_DT, VER_NBR, OBJ_ID)
  VALUES('1648', 'BloomingtonBranchApprovalRule', '1645', NULL, 1, 'Bloomington Branch Approval Rule', 0, 'XPathSplitNodeExampleDocType', NULL, 0, NULL, NULL, NULL, 1, 0, 0, NULL, TO_DATE('2015-05-20 13:08:13','YYYY-MM-DD HH24:MI:SS'), 1, SYS_GUID())
/
INSERT INTO KREW_RULE_T(RULE_ID, NM, RULE_TMPL_ID, RULE_EXPR_ID, ACTV_IND, RULE_BASE_VAL_DESC, FRC_ACTN, DOC_TYP_NM, DOC_HDR_ID, TMPL_RULE_IND, FRM_DT, TO_DT, DACTVN_DT, CUR_IND, RULE_VER_NBR, DLGN_IND, PREV_VER_RULE_ID, ACTVN_DT, VER_NBR, OBJ_ID)
  VALUES('1649', 'IndianapolisBranchApprovalRule', '1646', NULL, 1, 'Indianapolis Branch Approval Rule', 0, 'XPathSplitNodeExampleDocType', NULL, 0, NULL, NULL, NULL, 1, 0, 0, NULL, TO_DATE('2015-05-20 13:08:13','YYYY-MM-DD HH24:MI:SS'), 1, SYS_GUID())
/
INSERT INTO KREW_RULE_T(RULE_ID, NM, RULE_TMPL_ID, RULE_EXPR_ID, ACTV_IND, RULE_BASE_VAL_DESC, FRC_ACTN, DOC_TYP_NM, DOC_HDR_ID, TMPL_RULE_IND, FRM_DT, TO_DT, DACTVN_DT, CUR_IND, RULE_VER_NBR, DLGN_IND, PREV_VER_RULE_ID, ACTVN_DT, VER_NBR, OBJ_ID)
  VALUES('1650', 'OtherCampusBranchApprovalRule', '1647', NULL, 1, 'Other Branch Approval Rule', 0, 'XPathSplitNodeExampleDocType', NULL, 0, NULL, NULL, NULL, 1, 0, 0, NULL, TO_DATE('2015-05-20 13:08:13','YYYY-MM-DD HH24:MI:SS'), 1, SYS_GUID())
/
...
INSERT INTO KREW_RULE_RSP_T(RULE_RSP_ID, RSP_ID, RULE_ID, PRIO, ACTN_RQST_CD, NM, TYP, APPR_PLCY, VER_NBR, OBJ_ID)
  VALUES('2066', '2065', '1648', 1, 'A', 'testuser1', 'F', 'F', 1, SYS_GUID())
/
INSERT INTO KREW_RULE_RSP_T(RULE_RSP_ID, RSP_ID, RULE_ID, PRIO, ACTN_RQST_CD, NM, TYP, APPR_PLCY, VER_NBR, OBJ_ID)
  VALUES('2068', '2067', '1649', 1, 'A', 'testuser2', 'F', 'F', 1, SYS_GUID())
/
INSERT INTO KREW_RULE_RSP_T(RULE_RSP_ID, RSP_ID, RULE_ID, PRIO, ACTN_RQST_CD, NM, TYP, APPR_PLCY, VER_NBR, OBJ_ID)
  VALUES('2070', '2069', '1650', 1, 'A', 'testuser3', 'F', 'F', 1, SYS_GUID())
/
...
INSERT INTO KREW_EDL_ASSCTN_T(EDOCLT_ASSOC_ID, DOC_TYP_NM, EDL_DEF_NM, STYLE_NM, ACTV_IND, VER_NBR, OBJ_ID)
  VALUES(2024, 'XPathSplitNodeExampleDocType', 'XPathSplitNodeExampleForm', 'XPathSplitNodeExampleStyle', 1, 1, SYS_GUID())
/