...
/**
 * Defines the project identifier for the KRAD Sample App.
 *
 * @author Kuali Rice Team (rice.collab@kuali.org)
 */
@Configuration
@Import({ AutowiredProjectConfig.class })
public class KradSampleAppProjectConfig implements ProjectIdentifierConfig {

	// These 2 must always exactly match the information in the pom
	public static final ProjectIdentifier KRAD_SAP = new ProjectIdentifier(KualiProjectConstants.RICE_GROUP_ID, "rice-krad-sampleapp-web");
