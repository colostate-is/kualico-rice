 ...
 */
public class LabsKSAdminRegistrationAft extends WebDriverLegacyITBase {

    /**
     * /ksworkshop?viewId=KS-AdminRegistration
     */
    public static final String BOOKMARK_URL = "/kr-krad/ksworkshop?viewId=KS-AdminRegistration";
    ...
    protected void navigate() throws Exception {
    	waitAndClickByLinkText("KS Admin Registration");
    }
