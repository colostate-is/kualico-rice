...
/**
 * An immutable predicate which represents an "WHERE NOT EXISTS" statement.
 *
 ...
 *
 */
@XmlRootElement(name = NotExistsSubQueryPredicate.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = NotExistsSubQueryPredicate.Constants.TYPE_NAME, propOrder = {
    NotExistsSubQueryPredicate.Elements.SUB_QUERY_PREDICATE,
    CoreConstants.CommonElements.FUTURE_ELEMENTS
})
public final class NotExistsSubQueryPredicate extends AbstractPredicate implements SubQueryPredicate {
    ...
    private NotExistsSubQueryPredicate() {
    }

    public NotExistsSubQueryPredicate(String subQueryType, Predicate subQueryPredicate) {
        super();
    ...
    static class Constants {
        final static String ROOT_ELEMENT_NAME = "notExistsSubQuery";
        final static String TYPE_NAME = "NotExistsSubQueryType";
    }
