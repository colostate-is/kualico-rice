 ...
 */
public class FreemarkerAftGenerator {
    ...
    //Configuration
    private static TemplateLoader templateLoader = new ClassTemplateLoader(FreemarkerAftGenerator.class, DIR_TMPL);
    ...
    private static void createFile(String propLocation, String template) throws Exception {
        try {
            InputStream in = FreemarkerAftGenerator.class.getResourceAsStream(propLocation);
