 ...
 */
public class StateBasedValidationClientCustomizedTestsAft extends WebDriverLegacyITBase {

    /**
     * /kr-krad/uicomponents?viewId=Demo-StateBasedValidation-ClientCustom&methodToCall=start
     */
    public static final String BOOKMARK_URL ="/kr-krad/uicomponents?viewId=Demo-StateBasedValidation-ClientCustom&methodToCall=start";
    ...
    protected void navigate() throws InterruptedException {
        waitAndClickKRAD();
        waitAndClickByLinkText("State-based Validation (Client customized test)");
        switchToWindow("Kuali :: State-based Validation Custom client-side Test View");
    }
    
    private void testStateBasedValidationClientCustomizedTests() throws Exception{
        //State 1
    ...
    @Test
    public void testStateBasedValidationClientCustomizedTestsBookmark() throws Exception {
        testStateBasedValidationClientCustomizedTests();
        passed();
    }

    @Test
    public void testStateBasedValidationClientCustomizedTestsNav() throws Exception {
        testStateBasedValidationClientCustomizedTests();
        passed();
    }
