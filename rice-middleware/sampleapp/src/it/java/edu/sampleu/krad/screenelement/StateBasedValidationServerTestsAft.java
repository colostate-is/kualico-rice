 ...
 */
public class StateBasedValidationServerTestsAft extends WebDriverLegacyITBase {

    /**
     * /kr-krad/uicomponents?viewId=Demo-StateBasedValidation-Server&methodToCall=start
     */
    public static final String BOOKMARK_URL ="/kr-krad/uicomponents?viewId=Demo-StateBasedValidation-Server&methodToCall=start";
    ...
    protected void navigate() throws InterruptedException {
        waitAndClickKRAD();
        waitAndClickByLinkText("State-based Validation (Server test)");
        switchToWindow("Kuali :: State-based Validation Server-side Test View");
    }
    
    private void testStateBasedValidationServerTests() throws Exception{
        //State 1
    ...
    @Test
    public void testStateBasedValidationServerTestsBookmark() throws Exception {
        testStateBasedValidationServerTests();
        passed();
    }

    @Test
    public void testStateBasedValidationServerTestsNav() throws Exception {
        testStateBasedValidationServerTests();
        passed();
    }
