 ...
 */
public abstract class GroupActionListAftBase extends GroupAftBase {
     ...
     */    
    public static final String BOOKMARK_URL = AutomatedFunctionalTestUtils.PORTAL+"?channelTitle=Group&channelUrl="+ WebDriverUtils
            .getBaseUrlString()+"/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.rice.kim.impl.group.GroupBo&docFormKey=88888888&returnLocation="+
    ...
    public void testGroupActionListRecallAndCancel_WithPendingPersonApprove() throws Exception {
        String user = "erin";
        String docId = testCreateNew();
    ...
    public void testGroupActionListRecallToActionList_WithPendingPersonApprove() throws Exception {
        String user = "erin";
    ...
    public void testGroupActionListCancel_WithPendingPersonApprove()throws Exception {
        String docId = testCreateNew();
    ...
    public void testGroupActionListSave_WithPendingPersonApprove() throws Exception {
        String user = "erin";
        String docId = testCreateNew();
        addAdHocRecipientsPerson(new String[]{user, "A"});
        saveAndReload();
    ...
    public void assertGroupActionListSubmit_WithPersonRequest(String user, String action, String state) throws Exception {
    ...
    public void testGroupActionListSubmit() throws Exception {
        assertGroupActionListSubmit_WithPersonRequest("", "", "FINAL");
        passed();
    }

    public void testGroupActionListSubmit_WithPendingPersonApprove() throws Exception {
        assertGroupActionListSubmit_WithPersonRequest("erin", "A", "ENROUTE");
        passed();
    }

    public void testGroupActionListSubmit_WithPendingPersonAcknowledge() throws Exception {
        assertGroupActionListSubmit_WithPersonRequest("erin", "K", "PROCESSED");
        passed();
    }

    public void testGroupActionListSubmit_WithPendingPersonFyi() throws Exception {
        assertGroupActionListSubmit_WithPersonRequest("erin", "F", "FINAL");
        passed();
    }
