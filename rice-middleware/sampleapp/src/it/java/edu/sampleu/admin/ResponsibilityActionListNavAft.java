 ...
 */
public class ResponsibilityActionListNavAft extends ResponsibilityActionListAftBase {
    ...
    @Test
    public void testResponsibilityActionListSave_WithPendingPersonApprove_Nav() throws Exception {
        testResponsibilityActionListSave_WithPendingPersonApprove();
    }

    @Test
    public void testResponsibilityActionListCancel_WithPendingPersonApprove_Nav() throws Exception {
        testResponsibilityActionListCancel_WithPendingPersonApprove();
    }

    @Test
    @Ignore("Responsibility recall not implemented on screen")
    public void testResponsibilityActionListRecallAndCancel_WithPendingPersonApprove_Nav() throws Exception {
        testResponsibilityActionListRecallAndCancel_WithPendingPersonApprove();
    }

    @Test
    @Ignore("Responsibility recall not implemented on screen")
    public void testResponsibilityActionListRecallToActionList_WithPendingPersonApprove_Nav() throws Exception {
        testResponsibilityActionListRecallToActionList_WithPendingPersonApprove();
    }

    @Test
    public void testResponsibilityActionListSubmit_WithPendingPersonApprove_Nav() throws Exception {
        testResponsibilityActionListSubmit_WithPendingPersonApprove();
    }

    @Test
    public void testResponsibilityActionListSubmit_WithPendingPersonAcknowledge_Nav() throws Exception {
        testResponsibilityActionListSubmit_WithPendingPersonAcknowledge();
    }

    @Test
    public void testResponsibilityActionListSubmit_WithPendingPersonFyi_Nav() throws Exception {
