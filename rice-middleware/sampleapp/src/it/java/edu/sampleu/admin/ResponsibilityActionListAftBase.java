 ...
 */
public abstract class ResponsibilityActionListAftBase extends ResponsibilityAftBase {

    /**
     * AutomatedFunctionalTestUtils.PORTAL+"?channelTitle=Responsibility&channelUrl="+ WebDriverUtils
     * .getBaseUrlString()+"/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.rice.kim.impl.responsibility.UberResponsibilityBo&docFormKey=88888888&returnLocation="+
     * AutomatedFunctionalTestUtils.PORTAL_URL+ AutomatedFunctionalTestUtils.HIDE_RETURN_LINK;
     */    
    public static final String BOOKMARK_URL = AutomatedFunctionalTestUtils.PORTAL+"?channelTitle=Responsibility&channelUrl="+ WebDriverUtils
            .getBaseUrlString()+"/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.rice.kim.impl.responsibility.UberResponsibilityBo&docFormKey=88888888&returnLocation="+
            AutomatedFunctionalTestUtils.PORTAL_URL+ AutomatedFunctionalTestUtils.HIDE_RETURN_LINK;
    ...
    public void testResponsibilityActionListRecallAndCancel_WithPendingPersonApprove() throws Exception {
        String user = "erin";
        String docId = testCreateNew();
    ...
    public void testResponsibilityActionListRecallToActionList_WithPendingPersonApprove() throws Exception {
        String user = "erin";
    ...
    public void testResponsibilityActionListCancel_WithPendingPersonApprove()throws Exception {
        String docId = testCreateNew();
    ...
    public void testResponsibilityActionListSave_WithPendingPersonApprove() throws Exception {
        String user = "erin";
        String docId = testCreateNew();
        addAdHocRecipientsPerson(new String[]{user, "A"});
        saveAndReload();
    ...
    public void assertResponsibilityActionListSubmit_WithPersonRequest(String user, String action, String state) throws Exception {
    ...
    public void testResponsibilityActionListSubmit() throws Exception {
        assertResponsibilityActionListSubmit_WithPersonRequest("", "", "FINAL");
        passed();
    }

    public void testResponsibilityActionListSubmit_WithPendingPersonApprove() throws Exception {
        assertResponsibilityActionListSubmit_WithPersonRequest("erin", "A", "ENROUTE");
        passed();
    }

    public void testResponsibilityActionListSubmit_WithPendingPersonAcknowledge() throws Exception {
        assertResponsibilityActionListSubmit_WithPersonRequest("erin", "K", "PROCESSED");
        passed();
    }

    public void testResponsibilityActionListSubmit_WithPendingPersonFyi() throws Exception {
        assertResponsibilityActionListSubmit_WithPersonRequest("erin", "F", "FINAL");
        passed();
    }
