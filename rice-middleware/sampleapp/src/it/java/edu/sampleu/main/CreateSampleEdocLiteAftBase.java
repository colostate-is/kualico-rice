...
public class CreateSampleEdocLiteAftBase extends MainTmplMthdSTNavBase{
    ...
    /**
     * ITUtil.PORTAL + "?channelTitle=eDoc%20Lite&channelUrl=" + WebDriverUtils.getBaseUrlString() +
     ...
     */
    public static final String BOOKMARK_URL = AutomatedFunctionalTestUtils.PORTAL + "?channelTitle=eDoc%20Lite&channelUrl=" + WebDriverUtils
