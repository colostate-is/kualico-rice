 ...
 */
public class AdminEntityTypeAft extends WebDriverLegacyITBase {

    /**
     * AutomatedFunctionalTestUtils.PORTAL + "?channelTitle=Entity%20Type&channelUrl=" + WebDriverUtils
     * .getBaseUrlString() + "/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.rice.kim.impl.identity.EntityTypeBo&docFormKey=88888888&returnLocation=" +
    ...
    private void testEntityType() throws Exception{
        selectFrameIframePortlet();
        waitAndTypeByName("code","PERSON");
        waitAndClickByXpath("//input[@value='search']");
        String customSearchResult [] ={"PERSON","Person","01","Yes"};
